...
@Component({
  selector: 'app-nalangu',
  templateUrl: './nalangu.component.html',
  styleUrls: ['./nalangu.component.css'],
  animations:[
    trigger('animation',[
...
export class NalanguComponent {
  ...
  ngOnInit() {
    this.googleDriveService.setFolderId('1FKGovgwndMj410Zo0nenh_fy_MdG7d2y');
