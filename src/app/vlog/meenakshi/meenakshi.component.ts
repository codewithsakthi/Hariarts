 ...
 slider: KeenSliderInstance | null = null;
  ...
  defaultyear()
  {
    ...
    if (this.currentYear == 2022) {
      this.googleDriveService.setFolderId("1vJ9EBhw2_bpjaXqKzWXppvSBVVBKl3AI");
      this.yearselcted = true;
      this.validyear=true

    }
    if (this.currentYear == 2023) {
      this.googleDriveService.setFolderId("1ZTdgbTQxXPpKhfbfsNwwiDQbUeHiFehj");
      this.yearselcted = true;
      this.validyear=true
    ...
    if (this.currentYear == 2024) {
      this.googleDriveService.setFolderId("1bPodmKXeV4XK5SELCIYuvAI_oZsyKhu4");
      this.validyear = true

    }
    if (this.currentYear == 2025) {
      this.googleDriveService.setFolderId("1YxP75J-i6JwN_HtldO7F_ETngLAtOP20");
      this.validyear = true

    }
    if (this.currentYear == 2026) {
      this.googleDriveService.setFolderId("1U0CEsbLPZJFocWBsR45Ltklb3C1AkEkv");
      this.validyear = true
