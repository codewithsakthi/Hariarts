...
@Component({
  selector: 'app-upaanayana',
  templateUrl: './upanayana.component.html',
  styleUrls: ['./upanayana.component.css'],
  animations:[
    trigger('animation',[
...
export class UpanayanaComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('19XhrBLYnilOXUR8kcb1vRUDg-Ia6L51m');
    this.fetchFolders();
