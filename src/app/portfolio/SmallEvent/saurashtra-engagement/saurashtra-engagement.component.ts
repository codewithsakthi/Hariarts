...
@Component({
  selector: 'app-saurashtra-engagement',
  templateUrl: './saurashtra-engagement.component.html',
  styleUrls: ['./saurashtra-engagement.component.css'],
  animations:[
    trigger('animation',[
...
export class SaurashtraEngagementComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('1Ft7MDqrVNzxC8-1TqYHe8lboJ-I9ZUV5');
    this.fetchFolders();
