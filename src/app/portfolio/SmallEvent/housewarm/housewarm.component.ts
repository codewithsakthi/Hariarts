...
@Component({
  selector: 'app-housewarm',
  templateUrl: './housewarm.component.html',
  styleUrls: ['./housewarm.component.css'],
  animations:[
    trigger('animation',[
...
export class HousewarmComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('1xB8sTspYBvac3Gm6rulOp_x6HY7MDSQO');
    this.fetchFolders();
