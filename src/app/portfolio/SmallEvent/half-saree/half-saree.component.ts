...
@Component({
  selector: 'app-half-saree',
  templateUrl: './half-saree.component.html',
  styleUrls: ['./half-saree.component.css'],
  animations:[
    trigger('animation',[
...
export class HalfSareeComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('1ou06tByRARWcg1xABkhUmDff0z-wSDrL');
    this.fetchFolders();
