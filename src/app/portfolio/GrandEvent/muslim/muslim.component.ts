...
@Component({
  selector: 'app-muslim',
  templateUrl: './muslim.component.html',
  styleUrls: ['./muslim.component.css'],
  animations:[
    trigger('animation',[
...
export class MuslimComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('1MgQYmDcCl2w1ZzR8yXwDyvPoukEflL_K');
    this.fetchFolders();
