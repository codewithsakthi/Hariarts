...
@Component({
  selector: 'app-saurashtra',
  templateUrl: './saurashtra.component.html',
  styleUrls: ['./saurashtra.component.css'],
  animations:[
    trigger('animation',[
...
export class SaurashtraComponent implements OnInit {
  folders: any[] = [];
...
onImageLoad() {
  ...
  ngOnInit(): void {
    this.driveApiService.setFolderId('1cDUlqblFxuUk1zCfty6gCJ6F3ZnOqiWn');
    this.fetchFolders();
